                    ...
                    <Tooltip key={s.id}>
                      <TooltipTrigger asChild>
                        <button
                          ...
                          className={`w-5 h-5 rounded-full border-2 transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-accent focus-visible:ring-offset-2 focus-visible:ring-offset-background ${skinId === s.id ? "border-accent scale-125" : "border-transparent"}`}
                          style={{ background: s.hex }}
                        />
                      </TooltipTrigger>
                      <TooltipContent>Skin: {s.name}</TooltipContent>
                    </Tooltip>
                  ))}
                </div>
              </div>
                    ...
                    <Tooltip key={h.id}>
                      <TooltipTrigger asChild>
                        <button
                          ...
                          className={`w-5 h-5 rounded-full border-2 transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-accent focus-visible:ring-offset-2 focus-visible:ring-offset-background ${hairId === h.id ? "border-accent scale-125" : "border-transparent"}`}
                          style={{ background: h.hex }}
                        />
                      </TooltipTrigger>
                      <TooltipContent>Hair: {h.name}</TooltipContent>
                    </Tooltip>
                  ))}
                </div>
              </div>
